...
scraped_at: "2026-02-01T13:54:40.016Z"
---
...
-   You can only create 200 ad sets per ad campaign. [Learn more about the ad campaign structure](/docs/marketing-api/reference/ad-campaign-group).
-   If your campaign has more than 70 ad sets and uses [Campaign Budget Optimization](/docs/marketing-api/bidding/guides/campaign-budget-optimization), you are not able to edit your current bid strategy or turn off CBO. [Learn more in the Business Help Center](https://www.facebook.com/business/help/519856662172206).

### New Required Field for All Campaigns

All businesses using the Marketing API must identify whether or not new and edited campaigns belong to a [Special Ad Category](/docs/marketing-api/audiences/special-ad-category). Current available categories are: [housing, employment, credit](/docs/marketing-api/audiences/special-ad-category/#context), or issues, elections, and politics. Businesses whose ads do not belong to a Special Ad Category must indicate NONE or send an empty array in the `special_ad_categories` field.

Businesses running **housing**, **employment**, or **credit** ads must comply with [targeting and audience restrictions](#hec-restrictions). Targeting for ads about social issues, elections or politics are not affected by the `special_ad_categories` label.

As of **Marketing API 7.0**, the `special_ad_category` parameter on the [`POST /act_<ad_account_id>/campaigns`](/docs/marketing-api/reference/ad-account/campaigns/#Creating) endpoint has been deprecated and replaced with a new `special_ad_categories` parameter. The new `special_ad_categories` parameter is required and accepts an array.
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=...%3Ffields%3D%257Bfieldname_of_type_Campaign%257D&version=v24.0)

```
GET v24.0/...?fields={fieldname_of_type_Campaign} HTTP/1.1
...
[list<AdStudy>](https://developers.facebook.com/docs/marketing-api/reference/ad-study/)
...
Whether to automatically rebalance budgets daily for all the adsets under this campaign. [This has been deprecated on Marketing API V7.0](/docs/graph-api/changelog/version7.0#deprecations).
...
[Reach and Frequency](/docs/marketing-api/reachandfrequency) is disabled for [housing, employment and credit ads](/docs/marketing-api/special-ad-category).

`campaign_group_active_time`

numeric string

campaign\_group\_active\_time this is only for Internal, This will have the active running length of Campaign Groups
...
enum {ACTIVE, PAUSED, DELETED, ARCHIVED, IN\_PROCESS, WITH\_ISSUES}

IN\_PROCESS is available for version 4.0 or higher

`has_secondary_skadnetwork_reporting`

bool

has\_secondary\_skadnetwork\_reporting
...
Smart Promotion Type. guided\_creation or smart\_app\_promotion(the choice under APP\_INSTALLS objective).
...
If this status is `PAUSED`, all its active ad sets and ads will be paused and have an effective status `CAMPAIGN_PAUSED`. The field returns the same value as 'configured\_status', and is the suggested one to use.
...
[`ad_studies`](/docs/marketing-api/reference/ad-campaign-group/ad_studies/)

Edge<AdStudy>

The ad studies containing this campaign

[`adrules_governed`](/docs/marketing-api/reference/ad-campaign-group/adrules_governed/)
...
[`ads`](/docs/marketing-api/reference/ad-campaign-group/ads/)

Edge<Adgroup>

Ads under this campaign

[`adsets`](/docs/marketing-api/reference/ad-campaign-group/adsets/)

Edge<AdCampaign>

The ad sets under this campaign

[`copies`](/docs/marketing-api/reference/ad-campaign-group/copies/)
...
You can update a [Campaign](/docs/marketing-api/reference/ad-campaign-group/) by making a POST request to [`/{campaign_id}`](/docs/marketing-api/reference/ad-campaign-group/).
...
An array of maps containing all the non-deleted child adset IDs and either daily\_budget or lifetime\_budget, required in the process of toggling between campaign budget and adset budget
...
enum{GUIDED\_CREATION, SMART\_APP\_PROMOTION}

smart\_promotion\_type
...
You can delete a [Campaign](/docs/marketing-api/reference/ad-campaign-group/) by making a DELETE request to [`/{campaign_id}`](/docs/marketing-api/reference/ad-campaign-group/).
...
-   Video Ads
-   Carousel Ads
-   [Instant Experience Ads](/docs/marketing-api/guides/instant-experiences)
-   [App Ads](/docs/marketing-api/mobile-app-ads)
-   [Instagram Ads](/docs/marketing-api/guides/instagramads) (see [placement limitations](/docs/marketing-api/guides/instagramads/get-started#campaign))
-   [Segment Asset Customization Ads](/docs/marketing-api/dynamic-creative/segment-asset-customization)
-   [Placement Asset Customization Ads](/docs/marketing-api/dynamic-creative/placement-asset-customization)
-   [Multi-Language Ads](/docs/marketing-api/multi-language-ads)
-   [Dynamic Ads](/docs/marketing-api/dynamic-ads)
-   [Dynamic Creative](/docs/marketing-api/dynamic-creative/overview)
...
-   Carousel Ads
-   [Instant Experience Ads](/docs/marketing-api/guides/instant-experiences)
-   [Collection Ads](/docs/marketing-api/guides/collection)
-   [App Ads](/docs/marketing-api/mobile-app-ads)
-   [Instagram Ads](/docs/marketing-api/guides/instagramads) (see [placement limitations](/docs/marketing-api/guides/instagramads/get-started#campaign))
-   [Ads that click to Messenger](/docs/marketing-api/guides/messenger#destination)
-   [Offer Ads](/docs/marketing-api/guides/offer-ads)
-   [Segment Asset Customization Ads](/docs/marketing-api/dynamic-creative/segment-asset-customization)
-   [Placement Asset Customization Ads](/docs/marketing-api/dynamic-creative/placement-asset-customization)
-   [Multi-Language Ads](/docs/marketing-api/multi-language-ads)
-   [Dynamic Ads](/docs/marketing-api/dynamic-ads)
...
-   Video Ads
-   Carousel Ads
-   [Event and Local Ads](/docs/marketing-api/guides/event-ads)
...
-   Carousel Ads
-   [Instagram Ads](/docs/marketing-api/guides/instagramads) (see [placement limitations](/docs/marketing-api/guides/instagramads/get-started#campaign))
-   [Messenger Ads](/docs/marketing-api/guides/messenger#destination)
...
-   [Instagram Ads](/docs/marketing-api/guides/instagramads) (see [placement limitations](/docs/marketing-api/guides/instagramads/get-started#campaign))
-   [Dynamic Ads](/docs/marketing-api/dynamic-ads)
-   [Collaborative Ads](/docs/marketing-api/collaborative-ads)
...
See our [ads guide](https://www.facebook.com/business/ads-guide/) for a list of creatives supported per objective. In the API, the objective determines which [ad creatives](/docs/reference/ads-api/adcreative) are valid.
...
Tracking specs are applied by default based on the objective specified, please see the full list of defaults by objective [here](/docs/marketing-api/tracking-specs#default).
...
To specify to track an install or app event, set the following in your [ad](/docs/reference/ads-api/adgroup):
...
Certain objectives require the `promoted_object` to be set in ad sets. See [Promoted Object](/docs/marketing-api/reference/ad-promoted-object) for more information.

Objective

Required promoted\_object Fields
...
Certain types of ad [placements](/docs/reference/ads-api/targeting-specs/#placement) are valid only for specific objectives or creatives. See [Business Help Center, Available ad placements for marketing objectives](https://www.facebook.com/business/help/279271845888065?id=369787570424415).
...
Use click-through and view-through attribution windows for [ad set](/docs/marketing-api/reference/ad-campaign#Creating) to track conversions then use for ads delivery optimization. This is different from the attribution window you use for ads reporting. With `attribution_spec`, select a combination of click-through or view-through windows of 1 day or 7 days. The combinations you can use depend on your ad set's `optimization_goal` and campaign's `objective`.
...
![](https://lookaside.fbsbx.com/elementpath/media/?media_id=259407686111734&version=1753396254)
...
![](https://lookaside.fbsbx.com/elementpath/media/?media_id=1277316779360194&version=1753396254)
...
`CONVERSIONS`  
(See [Available conversion locations and events by objective in Meta Ads Manager](https://www.facebook.com/business/help/2035196646663270) for more information on available conversion events by objective.)
