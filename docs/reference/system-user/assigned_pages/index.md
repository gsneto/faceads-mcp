---
title: "Graph API Referência v24.0: System User Assigned Pages"
source: "https://developers.facebook.com/docs/marketing-api/reference/system-user/assigned_pages/"
scraped_at: "2026-02-01T16:17:25.988Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bsystem-user-id%7D%2Fassigned_pages&version=v24.0)

```
GET /v24.0/{system-user-id}/assigned_pages HTTP/1.1
