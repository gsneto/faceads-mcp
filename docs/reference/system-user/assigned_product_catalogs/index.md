---
title: "Graph API Referência v24.0: System User Assigned Product Catalogs"
source: "https://developers.facebook.com/docs/marketing-api/reference/system-user/assigned_product_catalogs/"
scraped_at: "2026-02-01T16:17:31.777Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bsystem-user-id%7D%2Fassigned_product_catalogs&version=v24.0)

```
GET /v24.0/{system-user-id}/assigned_product_catalogs HTTP/1.1
