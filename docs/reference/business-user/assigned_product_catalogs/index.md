---
title: "Graph API Referência v24.0: Business User Assigned Product Catalogs"
source: "https://developers.facebook.com/docs/marketing-api/reference/business-user/assigned_product_catalogs/"
scraped_at: "2026-02-01T16:12:01.805Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bbusiness-user-id%7D%2Fassigned_product_catalogs&version=v24.0)

```
GET /v24.0/{business-user-id}/assigned_product_catalogs HTTP/1.1
...
Checks if business has owner or agency access on the asset
