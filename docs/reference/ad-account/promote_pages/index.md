---
title: "Graph API Referência v24.0: Ad Account Promote Pages"
source: "https://developers.facebook.com/docs/marketing-api/reference/ad-account/promote_pages/"
scraped_at: "2026-02-01T16:04:07.376Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bad-account-id%7D%2Fpromote_pages&version=v24.0)

```
GET /v24.0/{ad-account-id}/promote_pages HTTP/1.1
