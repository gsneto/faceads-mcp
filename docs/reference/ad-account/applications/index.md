---
title: "Graph API Referência v24.0: Ad Account Applications"
source: "https://developers.facebook.com/docs/marketing-api/reference/ad-account/applications/"
scraped_at: "2026-02-01T14:34:01.886Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bad-account-id%7D%2Fapplications&version=v24.0)

```
GET /v24.0/{ad-account-id}/applications HTTP/1.1
