...
source: "https://developers.facebook.com/docs/marketing-api/reference/ad-campaign/insights/"
scraped_at: "2026-02-01T14:31:05.343Z"
---
...
-   [`/{ad_set_id}/insights`](/docs/marketing-api/reference/ad-campaign/insights/)
...
When this parameter is set to true, your ads results will be shown using unified attribution settings defined at ad set level and parameter use\_account\_attribution\_setting will be ignored.
