...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDKcURL[Graph API Explorer](/tools/explorer/?method=GET&path=%3CAD_SET_ID%3E%2Fads%3Ffields%3Dname%252Cid&version=v24.0)

```
GET /v24.0/<AD_SET_ID>/ads?fields=name%2Cid HTTP/1.1
