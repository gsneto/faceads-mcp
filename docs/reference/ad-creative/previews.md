---
title: "Graph API Referência v24.0: Ad Creative Previews"
source: "https://developers.facebook.com/docs/marketing-api/reference/ad-creative/previews"
scraped_at: "2026-02-01T16:06:14.437Z"
---
...
-   [`ad_ACCOUNT_ID/ads`, Create](/docs/marketing-api/reference/adgroup/)
    
-   [`ad_ACCOUNT_ID/adcreatives`, Create](/docs/marketing-api/reference/ad-creative/)
    
-   [`/ad_ID`, Update](/docs/marketing-api/reference/adgroup/)
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDKcURL[Graph API Explorer](/tools/explorer/?method=GET&path=%3CCREATIVE_ID%3E%2Fpreviews%3Fad_format%3DDESKTOP_FEED_STANDARD%26product_item_ids%3D%255B%2522%253CPRODUCT_ITEM_ID%253E%2522%255D&version=v24.0)
