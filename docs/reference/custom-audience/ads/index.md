---
title: "Graph API Referência v24.0: Custom Audience Ads"
source: "https://developers.facebook.com/docs/marketing-api/reference/custom-audience/ads/"
scraped_at: "2026-02-01T14:29:33.915Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bcustom-audience-id%7D%2Fads&version=v24.0)

```
GET /v24.0/{custom-audience-id}/ads HTTP/1.1
...
The effective status of the ad. The field returns the same value as 'effective\_status', and is the suggested one to use.
