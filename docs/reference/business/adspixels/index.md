---
title: "Graph API Referência v24.0: Business Adspixels"
source: "https://developers.facebook.com/docs/marketing-api/reference/business/adspixels/"
scraped_at: "2026-02-01T16:06:52.337Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bbusiness-id%7D%2Fadspixels&version=v24.0)

```
GET /v24.0/{business-id}/adspixels HTTP/1.1
...
Retrieve a list of matching pixels based on the pixel ID.

`name_filter`

string

Retrieve a list of matching pixels based on the pixel name. Case insensitive.
...
Total number of items in this edge.
