---
title: "Graph API Referência v24.0: Business Pending Users"
source: "https://developers.facebook.com/docs/marketing-api/reference/business/pending_users/"
scraped_at: "2026-02-01T16:10:33.210Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bbusiness-id%7D%2Fpending_users&version=v24.0)

```
GET /v24.0/{business-id}/pending_users HTTP/1.1
...
Email of person invited to access this business.
...
Uma lista de nós [BusinessRoleRequest](/docs/marketing-api/reference/business-role-request/).
