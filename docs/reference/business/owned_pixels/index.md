---
title: "Graph API Referência v24.0: Business Owned Pixels"
source: "https://developers.facebook.com/docs/marketing-api/reference/business/owned_pixels/"
scraped_at: "2026-02-01T16:09:56.173Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bbusiness-id%7D%2Fowned_pixels&version=v24.0)

```
GET /v24.0/{business-id}/owned_pixels HTTP/1.1
