---
title: "Graph API Referência v24.0: Business Initiated Audience Sharing Requests"
source: "https://developers.facebook.com/docs/marketing-api/reference/business/initiated_audience_sharing_requests/"
scraped_at: "2026-02-01T16:08:57.106Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bbusiness-id%7D%2Finitiated_audience_sharing_requests&version=v24.0)

```
GET /v24.0/{business-id}/initiated_audience_sharing_requests HTTP/1.1
