---
title: "Graph API Referência v24.0: Business Owned Instagram Accounts"
source: "https://developers.facebook.com/docs/marketing-api/reference/business/owned_instagram_accounts/"
scraped_at: "2026-02-01T16:09:31.084Z"
---
...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](/tools/explorer/?method=GET&path=%7Bbusiness-id%7D%2Fowned_instagram_accounts&version=v24.0)

```
GET /v24.0/{business-id}/owned_instagram_accounts HTTP/1.1
