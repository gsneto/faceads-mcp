...
scraped_at: "2026-02-01T14:02:19.254Z"
---
...
Language of the below adjacent post content in [ISO 639-1](https://l.facebook.com/l.php?u=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FISO_639-1&h=AT3mS_pBGjWFyyVt2QvavnCjcrUYaGWSfZ8lRDvVZJ3bMgz8JgdAT4MCAJpOv3mPmJx5iCqlNSo8JWlbG-2F0FlkG6BkhgRiamHed9MspmMoW0hHUoGfsc6L3HinoYC7piLUrZ6fYM5bEqo1NB0B35q3VJSYjRq-icjeFkDKuW4) code format. A value of **null** indicates the language is _undetectable_. Supported languages are: Arabic (ar), English (en), Spanish (es), French (fr), Portuguese (pt), Chinese (zh), German (de), Assamese (as), Bengali (bn), Bhojpuri (bp), Gujarati (gu), Hindi (hi), Italian (it), Japanese (ja), Kannada (kn), Malayalam (ml), Marathi (mr), Malay (ms), Oriya (or), Punjabi (pa), Polish (pl), Swedish (sv), Tamil (ta), Telugu (te), Thai (th), Turkish (tr), Urdu (ur), Vietnamese (vi).
...
Language of the adjacent post content in [ISO 639-1](https://l.facebook.com/l.php?u=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FISO_639-1&h=AT0j66OsM8cd4Y4bHZDjd1SNc8UlA35OSxvUdaYdhFBqGPpJQXqvVDbi2ILxJ9iBoE4EPCIo0rVMmXvKLFSHkBESIv5YIkaSfyDlDEEs8Sfuocd5j3sH8UKdCtrVLq8-Dp6r8vZkte6E6LhG5TOVFj9gpQFpX1_vmf5nS3b0mXs) code format. A value of null indicates the language is undetectable. The 34 supported languages are: Arabic (ar), Assamese (as), Bengali (bn), Bhojpuri (bp), Chinese (zh), Dutch (nl), English (en), French (fr), German (de), Gujarati (gu), Hebrew (he), Hindi (hi), Indonesian (id), Italian (it), Japanese (ja), Kannada (kn), Korean (ko), Malay (ms), Malayalam (ml), Marathi (mr), Oriya (or), Polish (pl), Portuguese (pt), Punjabi (pa), Romanian (ro), Spanish (es), Swedish (sv), Tamil (ta), Telugu (te), Thai (th), Turkish (tr), Ukranian (uk), Urdu (ur), Vietnamese (vi).
