---
title: "Catálogo"
source: "https://developers.facebook.com/docs/marketing-api/dynamic-product-ads/product-catalog"
scraped_at: "2026-02-01T14:27:20.684Z"
---

[Voltar para Português (Brasil)](/docs/marketing-api/catalog/?translation)

Este documento foi atualizado.  
A tradução para Português (Brasil) não foi concluída ainda.

Atualização em inglês: 29 de jan  
Atualização em Português (Brasil): 21 de nov de 2024
...
-   **[Collection Ads](https://developers.facebook.com/docs/marketing-api/guides/collection)** — Ads that allow people to discover, browse, and purchase products and services in a visual and immersive way.
